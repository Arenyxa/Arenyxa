...
class SQLiteDatabaseAdapter:
    ...
    def ensure_schema(self, table: str, columns: Mapping[str, str]) -> None:
        ...
        connection.execute("CREATE TABLE IF NOT EXISTS " + safe_table + " (" + definitions + ")")
        connection.commit()
    ...
    def _identifier(value: str) -> str:
        if not isinstance(value, str) or not value or not value.replace("_", "").isalnum() or value[0].isdigit():
