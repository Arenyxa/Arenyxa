...
SQLiteStore and atomic_io own transaction/atomic-write durability.

## Consequence / invariant

Success is not reported before durable commit; callers do not bypass storage invariants.
