...
class PerformancePolicy:
    ...
    def resolve(
        ...
        # Resolve through the public package when it is loaded.  Apart from
        # keeping the public seam mockable, this lets embedders provide a
        # platform-specific detector without replacing the policy class.
        performance_module = sys.modules.get("arenyxa.performance")
        detector = getattr(performance_module, "detect_device_capability", detect_device_capability)
        device = detector()
