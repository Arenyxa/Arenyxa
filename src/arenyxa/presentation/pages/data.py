...
from arenyxa.qt_compat.QtCore import QModelIndex
...
class DataPage(WorkspacePage):
    def __init__(self, context: Any, theme: Any, motion: Any, parent: QWidget | None = None) -> None:
        ...
        self.model = VirtualTableModel(
            self._load_page,
            page_size=self.context.performance.result_page_size,
            max_cached_pages=32,
        )
    ...
    def inspect_row(self, current: QModelIndex, previous: QModelIndex) -> None:
        del previous
