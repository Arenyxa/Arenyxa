...
def _widget_refresh_hz(widget: QWidget) -> float:
    ...
    try:
        ...
        record_current_exception(__name__, '_widget_refresh_hz:51')
    return 60.0
        ...
        try:
            ...
            if was_visible:
                try:
                    ...
                    record_current_exception(__name__, '_StartupHandoffOverlay.capture_workspace:212')
        if snapshot.isNull():
            return False
    ...
    def start_exit(self) -> None:
        ...
        def complete() -> None:
            ...
            try:
                ...
                record_current_exception(__name__, '_StartupHandoffOverlay.start_exit.complete:251')
    ...
    def abort(self) -> None:
        ...
        if self._animation is not None:
            try:
                ...
                record_current_exception(__name__, 'StartupSplash.abort:391')
            self._animation = None
        try:
            self.hide()
            self.deleteLater()
        except RuntimeError:
            record_current_exception(__name__, 'StartupSplash.abort:397')
    ...
    def finish(self, main_window: QWidget | None = None) -> None:
        ...
        if overlay is not None:
            try:
                ...
                try:
                    ...
                    record_current_exception(__name__, 'StartupSplash.finish:458')
                self._handoff_overlay = None
        ...
        def complete() -> None:
            ...
            try:
                ...
                record_current_exception(__name__, 'StartupSplash.finish.complete:489')
