# Arenyxa icon provenance

- Canonical application icon: `arenyxa.png` (1024 × 1024, RGBA).
- Windows multi-size icon: `arenyxa.ico` containing 16, 24, 32, 48, 64, 128, and 256 px entries.
- v8.1 introduces the user-approved minimal premium Arenyxa identity: a geometric `A` frame around a luminous core, using a restrained graphite / electric-blue visual language.
- Source artwork SHA-256: `bf64855b08ebf96faac6672f11d0213542fc7d63947d54365189cc2bb2054242`.
