...
DEFAULT_CAPABILITIES: tuple[CapabilityDefinition, ...] = (
    ...
    CapabilityDefinition("enterprise.vault.manage", TrustDomain.ENTERPRISE),
    CapabilityDefinition("enterprise.proxy.manage", TrustDomain.ENTERPRISE),
    CapabilityDefinition("enterprise.mitm.manage", TrustDomain.ENTERPRISE),
    CapabilityDefinition("enterprise.packet.analyze", TrustDomain.ENTERPRISE),
    CapabilityDefinition("enterprise.network.observe", TrustDomain.ENTERPRISE),
)
