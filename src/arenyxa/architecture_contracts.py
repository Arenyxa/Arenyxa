...
COMPATIBILITY_CONTRACTS: tuple[CompatibilityContract, ...] = (
    CompatibilityContract("arenyxa", "python-package", "Public facade remains importable and re-exports version metadata.", "8.1"),
    CompatibilityContract("arenyxa", "legacy-python-package", "Historical implementation namespace remains importable through v8.1.", "8.1"),
    CompatibilityContract("arenyxa", "cli", "arenyxa -> arenyxa.cli:main unified professional control plane", "8.1"),
    CompatibilityContract("arenyxa-gui", "desktop-cli", "arenyxa-gui -> arenyxa.app:main desktop launcher", "8.1"),
    CompatibilityContract("python -m arenyxa", "legacy-desktop-cli", "Historical desktop launch remains available", "8.1"),
    CompatibilityContract("arenyxa-server", "cli", "arenyxa-server -> arenyxa.infrastructure.server:main", "8.1"),
